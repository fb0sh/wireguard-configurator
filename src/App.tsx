      ...
      <nav className="navbar">
        <div className="navbar-inner">
          ...
          <div className="navbar-links">
            ...
            <a href="https://github.com/fb0sh/wireguard-configurator" target="_blank" rel="noopener" className="gh-link lang-link inactive-lang" style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <div className="panel-body">
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <input list="cidr-presets" value={vpnCidr} onChange={e => setVpnCidr(e.target.value)} className="input" />
                <datalist id="cidr-presets">
                  <option value="10.10.1.0/24" />
                  <option value="10.20.2.0/24" />
                  <option value="10.30.3.0/24" />
                  <option value="10.40.4.0/24" />
                  <option value="172.16.0.0/24" />
                  <option value="192.168.100.0/24" />
                </datalist>
              </div>
